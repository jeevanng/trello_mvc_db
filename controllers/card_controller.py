...
# Need to be defined BEFORE we use the decorator 
...
@jwt_required()
# Need to write the new decorator below jwt_required()
@authorise_as_admin
# IN THIS CASE return fn in the wrapper will be def_delete_one_card(id)
